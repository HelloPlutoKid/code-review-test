      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-100 to-pink-100 p-8 rounded-2xl shadow-lg">
              <div className="text-4xl mb-4">📱</div>
            ...
            <div className="bg-gradient-to-br from-pink-100 to-purple-100 p-8 rounded-2xl shadow-lg">
              <div className="text-4xl mb-4">🎯</div>
