        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fadeInUp opacity-0 animation-delay-600">
            <a
              ...
              className="bg-red-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-red-700 transition-all hover:scale-110 hover:shadow-2xl shadow-lg animate-bounce-slow"
            >
              유튜브 구독하기
            </a>
            <a
              href="#videos"
              className="bg-white text-purple-600 border-2 border-purple-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-purple-50 transition-all hover:scale-110 hover:shadow-2xl shadow-lg"
            >
              영상 보러가기
            </a>
          </div>
